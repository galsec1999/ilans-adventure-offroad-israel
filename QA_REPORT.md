# דוח בקרת איכות — גרסת מסמך 2.3.1
...
GitHub Pages פרס בהצלחה את commit `792ca645b2640103eec725ed93915f8423036390` בריצה `31305561155`. באתר החי אומתו מוצר 2.5.0, מסמך 2.3.2, 339 כרטיסים, 276 לוחות תוואי, 5 אזהרות סתירה, noindex, manifest יחסי, מטמון `2.5.0-doc-2.3.2`, קוד התקנה, שני דוחות האמינות ושלושה סמלי PWA. `robots.txt` תואם במדויק ו־`sitemap.xml` מחזיר 404.
