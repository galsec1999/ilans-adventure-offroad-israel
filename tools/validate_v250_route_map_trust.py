"""שער אמינות כרטיס–מפה 2.5.0 — גרסת מסמך 1.0.3; מסמך אתר 2.4.0."""
...
def main() -> int:
    ...
    require("גרסת מוצר 2.6.0" in index and "גרסת מסמך 2.4.0" in index, "visible main versions")
    require("2.6.0-doc-2.4.0" in sw and "./data/route-map-trust-audit.json" in sw, "PWA cache includes trust audit")
