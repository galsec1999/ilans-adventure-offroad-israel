...
def main() -> int:
    ...
    check(routes["documentVersion"] == DATA_DOCUMENT_VERSION, "routes dataset document version is 2.2.1")
    check(metadata["documentVersion"] == "2.2.0", "metadata dataset document version is 2.2.0")
    ...
    check(metadata_js.startswith("/* מטא-דאטה Off-Road — גרסת מסמך 2.2.0"), "metadata JavaScript shows document version")
